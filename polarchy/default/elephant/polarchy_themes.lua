--
-- Dynamic Polarchy Theme Menu for Elephant/Walker
--
Name = "polarchythemes"
NamePretty = "Polarchy Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/polarchy/themes"
  local polarchy_path = os.getenv("POLARCHY_PATH") or ""
  local default_theme_dir = polarchy_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "polarchy-theme-set " .. theme_name,
            },
          })
        end
      end
