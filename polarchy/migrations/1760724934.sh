...
cp -r $POLARCHY_PATH/config/polarchy/* $HOME/.config/polarchy/

echo "Add packages for updated polarchy-cmd-screenshot"
polarchy-pkg-add grim slurp wayfreeze-git

echo "Add nfs support by default to Nautilus"
polarchy-pkg-add gvfs-nfs
